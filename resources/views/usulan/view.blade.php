								...
								<div class="tab-pane fade show active" id="dangerhome" role="tabpanel">
									...
									<div class="row">
										<div class="col-4">
											...
											<div class="input-group input-group-sm"> 
												<input type="number" class="form-control"  name="nama_barang"  value="{{$data->nama_barang}}" placeholder="Enter......">
											</div>
										</div>
										<div class="col-2">
											<label class="form-label">Mata Uang</label>
											<div class="input-group input-group-sm"> 
												<input type="text" class="form-control"  name="qty"  value="{{$data->qty}}"  placeholder="Enter......">
											</div>
										</div>
										<div class="col-4">
