...
@endsection
@push('ajax')
	<script src="{{url_plug()}}/assets/plugins/chartjs/js/Chart.min.js"></script>
  	<script src="{{url_plug()}}/assets/plugins/chartjs/js/Chart.extension.js"></script>
	<script src="{{url_plug()}}/assets/plugins/chartjs/js/chartjs-custom.js"></script>
@endpush